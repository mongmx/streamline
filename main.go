...
import (
	...
	_ "github.com/mongmx/sse-redis/docs" // docs is generated by Swag CLI, you have to import it.
...
func main() {
	...
	eg.Go(func() error {
		return apiRouter.StartServer(apiRouter.Server)
	})
	eg.Go(func() error {
...
func apiInstance(routerMetrics *echo.Echo) *echo.Echo {
	...
	r := mux.NewRouter()
	r.HandleFunc("/", adminHandler.Index2).Methods("GET").Name("index")
	e.GET("/", echo.WrapHandler(r.GetRoute("index").GetHandler()))
