...
// source: /Users/mongmx/workspace/go/src/github.com/mongmx/streamline/templates/auth/signup.html
// DO NOT EDIT!
package t

import "bytes"

func ViewSignupPage(buffer *bytes.Buffer) {
	buffer.WriteString(`
    ...
    >
        <div class="flex flex-col overflow-y-auto md:flex-row">
            ...
            <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                <div class="w-full" x-data="signinForm()">
                    <h1
